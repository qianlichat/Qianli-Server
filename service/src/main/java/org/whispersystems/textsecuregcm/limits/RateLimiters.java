...
public class RateLimiters extends BaseRateLimiters<RateLimiters.For> {
  ...
  public enum For implements RateLimiterDescriptor {
    ...
    LOOKUP_ACCOUNT_ID_OPERATION("lookupAccountIdOperation", false, new RateLimiterConfig(10, Duration.ofMinutes(1))),
    GET_PASSWORD_SIGN_KEY_OPERATION("getPasswordSignKeyOperation", false, new RateLimiterConfig(5, Duration.ofMinutes(1))),
    CHANGE_PASSWORD_OPERATION("getPasswordSignKeyOperation", false, new RateLimiterConfig(5, Duration.ofMinutes(5))),
    LOOKUP_ACI_OPERATION("lookupAciOperation", false, new RateLimiterConfig(10, Duration.ofMinutes(1))),
    GEN_TOTP_OPERATION("lookupAciOperation", false, new RateLimiterConfig(5, Duration.ofMinutes(1))),
    BIND_TOTP_OPERATION("lookupAciOperation", false, new RateLimiterConfig(10, Duration.ofMinutes(1))),
